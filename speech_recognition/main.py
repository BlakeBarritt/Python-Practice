...
def speak(audio_string):
    """ Take text and make a audio file to be played """
...
def respond(voice_data):
    ...
    if there_exists(['hey','hi','hello']):
        greetings = [f"Hello, how can I help you {person_obj.name}", f"Hey, what's up? {person_obj.name}", f"I'm listening {person_obj.name}", f"how can I help you? {person_obj.name}"]
    ...
    if there_exists(["how are you","how are you doing"]):
        speak(f"I'm vibing {person_obj.name}")
